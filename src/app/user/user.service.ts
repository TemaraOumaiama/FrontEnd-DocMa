...
public updateUserPassword(userName: string , newPassword: string): Observable<any> {
  ...
  public createUserFormDate(loggedInUsername: string|null|undefined, user: User|null, imageUrl: File|undefined|null): FormData {
