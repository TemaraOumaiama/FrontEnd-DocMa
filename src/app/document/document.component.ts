...
constructor(private router: Router,private UserService:UserService,private CategorieService: CategorieService, private DocumentService: DocumentService,private DepartementService: DepartementService ){}
...
onAddDocument(addForm: NgForm, departementSelect: HTMLSelectElement, categorieSelect: HTMLSelectElement, fileInput: HTMLInputElement) {
...
public getSortedDocuments(): void {
  ...
  this.UserService.getDocumentsCreatedByUser(userId)
